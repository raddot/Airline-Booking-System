...
public class PrintTicket1 extends JFrame{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		int confirmation_Number=rand.nextInt(60);
		...
		JLabel LTicketNo=new JLabel("<html><font color=\"#000000\">Confirmation Number &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: &nbsp;"+ confirmation_Number+"</font></html>");
		...
		JLabel Radhika=new JLabel("<html><I><font color=\"#8FBC8F\">Radhika Dotihal</font></I></html>");
		...
		Radhika.setBounds(285,485,300,20);
