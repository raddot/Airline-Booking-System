...
public class InternationalFlight extends JFrame{
	...
	public InternationalFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Trivandrum","Mumbai","Kolkata", "Hyderabad", "Delhi"};
		...
		ImageIcon img1 = new ImageIcon(this.getClass().getResource("/map1.jpg"));
		...
		ImageIcon img2 = new ImageIcon(this.getClass().getResource("/note_bg.gif"));
...
//read from data
			...
			do
			{
				...
				LocalDate Past = LocalDate.of(2021,1,1);
				LocalDate dateNow = LocalDate.parse(getdateNow(),
                        DateTimeFormatter.ofPattern("dd/MM/yyyy"));
				if (dateNow.isAfter(Past) && Actual.isBefore(dateNow)) 
				{
...
System.out.println(temp1);
	...
	private CharSequence getdateNow() {
